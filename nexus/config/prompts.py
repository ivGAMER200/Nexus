...
SYSTEM_PROMPT: str = """You are Nexus, an elite AI coding agent.
...
CODE_REVIEW_PROMPT: str = """Review the following code and provide feedback on:
...
CODE_GENERATION_PROMPT: str = """Generate code based on the following requirements:
